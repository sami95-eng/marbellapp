...
const themeColors = {
  ...
  muted: { light: '#666666', dark: '#9CA3AF' }, // Gray / Lighter Gray for readability
  border: { light: '#E5E7EB', dark: '#2A3040' }, // Light Gray / Subtle Navy Border
  success: { light: '#22C55E', dark: '#4ADE80' },
  warning: { light: '#F59E0B', dark: '#FBBF24' },
  error: { light: '#EF4444', dark: '#F87171' },
  accent: { light: '#1ABC9C', dark: '#2DD4BF' }, // Teal accent - slightly brighter in dark
};
